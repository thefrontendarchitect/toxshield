    ...
    <div>
      ...
      <div className="bg-black border-2 border-white/15 rounded-2xl p-6 space-y-5">
        <div className="text-center space-y-2">
          <p className="text-[14px] text-white/30 font-mono tracking-[0.3em] uppercase">ToxShield Analysis</p>
        ...
        <p className="text-center text-[14px] text-white/20 font-mono">Analyze your circle → toxshield.app</p>
      </div>
