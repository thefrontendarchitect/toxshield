  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-surface-0 px-4 text-center">
      ...
      <h1 className="text-6xl font-black font-display text-text-primary tracking-[0.15em] text-glow mb-4">
        SYSTEM <span className="text-neon-magenta">FAULT</span>
      </h1>
      <div className="flex items-center gap-3 mb-8">
        <div className="h-[1px] w-12 bg-gradient-to-r from-transparent to-neon-magenta/40" />
        <p className="text-xs text-neon-magenta font-mono tracking-[0.2em] uppercase">
          Unexpected Error
        </p>
        <div className="h-[1px] w-12 bg-gradient-to-l from-transparent to-neon-magenta/40" />
      </div>
